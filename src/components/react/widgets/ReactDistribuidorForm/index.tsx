  ...
  return (
    <div className="mx-auto w-full">
      <form
        ...
        name="Formulário Seja Distribuidor"
      ...
      >
        <div className="mb-6 flex flex-col gap-8 md:mb-8 md:gap-12">
          ...
          <div>
            <h3 className="text-agua-primary-blue font-bevan mb-4 text-2xl font-normal uppercase md:mb-6 md:text-4xl">
              Informações de Contato
            </h3>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <FormField
              ...
              label={
                <>
                  ...
                  <span
                    ...
                    className="text-agua-primary-blue hover:text-caju-secondary-orange cursor-pointer font-semibold underline"
                  >
