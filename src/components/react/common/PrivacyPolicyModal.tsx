...
export function PrivacyPolicyModal({ isOpen, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm hide-scrollbar">
      <button
        onClick={onClose}
        className="absolute z-50 top-10 right-5 rounded-full p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700"
      >
        <X size={24} color="#FFF" className="bg-gray-400 rounded-full" />
      </button>
      <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-xl md:p-8 hide-scrollbar">
        <div className="prose [&_h4]:font-inter! prose-sm md:prose-base font-inter max-w-none">
          <h3 className="text-caju-heading-primary mb-6 text-xl font-bevan font-bold!">
          ...
          <p>
            Coletamos informações que você nos fornece diretamente ao preencher nossos formulários,
            como nome, e-mail, telefone e informações sobre sua solicitação.
          </p>
          <br />
          ...
          <p>
            Não vendemos ou alugamos seus dados pessoais. Podemos compartilhar suas informações com
            prestadores de serviços que nos ajudam a operar nosso negócio, sempre sob
            confidencialidade.
          </p>
          <br />
          ...
          <h4>5. Segurança</h4>
          <p>
            Adotamos medidas de segurança técnicas e organizacionais para proteger seus dados contra
